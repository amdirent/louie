...
var LoadingComponent = function (_React$PureComponent) {
  ...
  _createClass(LoadingComponent, [{
    ...
    value: function componentDidMount(promise) {
      var _this2 = this;

      promise.then(function (result) {
        var newState = _extends({}, result, { loaded: true });
...
var _LoadingComponent = require('./LoadingComponent.js');

Object.defineProperty(exports, 'LoadingComponent', {
  enumerable: true,
  get: function get() {
    return _LoadingComponent.LoadingComponent;
  }
});
