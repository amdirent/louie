...
var Auth0Strategy = function () {
  ...
  _createClass(Auth0Strategy, [{
    ...
    value: function clearSession() {
      ...
      _jsCookie2.default.remove('idToken', { domain: '.rentbutter.com' });
      _jsCookie2.default.remove('id_token', { domain: '.rentbutter.com' });
      _jsCookie2.default.remove('accessToken', { domain: '.rentbutter.com' });
      _jsCookie2.default.remove('access_token', { domain: '.rentbutter.com' });
      _jsCookie2.default.remove('expiresAt', { domain: '.rentbutter.com' });
      _jsCookie2.default.remove('scope', { domain: '.rentbutter.com' });
      _jsCookie2.default.remove('role', { domain: '.rentbutter.com' });
      _jsCookie2.default.remove('accountId', { domain: '.rentbutter.com' });
      _jsCookie2.default.remove('access_token', { domain: '.rentbutter.com' });
    }
  }, {
    key: 'setSession',
    ...
    value: function getUser() {
      try {
        var token = sessionStorage.getItem('idToken') || _jsCookie2.default.get('idToken');
    ...
    value: function getAccessToken() {
      var token = sessionStorage.getItem('accessToken') || _jsCookie2.default.get('accessToken');
      return token;
    }
  }, {
    key: 'changePassword',
