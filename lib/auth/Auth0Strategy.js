...
var Auth0Strategy = function () {
  ...
  _createClass(Auth0Strategy, [{
    ...
    value: function clearSession() {
      ...
      _jsCookie2.default.remove('idToken');
      _jsCookie2.default.remove('accessToken');
      _jsCookie2.default.remove('expiresAt');
      _jsCookie2.default.remove('scope');
      _jsCookie2.default.remove('role');
      _jsCookie2.default.remove('accountId');
    }
  }, {
    key: 'setSession',
    value: function setSession(authResult, callback) {
      ...
      this.setDataItem('role', (0, _jwtDecode2.default)(authResult.idToken)[process.env.APP_URI + '/roles']);
      this.setDataItem('accountId', (0, _jwtDecode2.default)(authResult.idToken)[process.env.APP_URI + '/accountId']);
    ...
    value: function getRole() {
      var role = _jsCookie2.default.get('role');
      return role;
    }
  }, {
    key: 'getAccountId',
    value: function getAccountId() {
      var accountId = _jsCookie2.default.get('accountId');
      return accountId;
    }
  }, {
    key: 'changePassword',
