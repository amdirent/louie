...
var AuthenticatedComponent = function (_LoadingComponent) {
  ...
  function AuthenticatedComponent() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = AuthenticatedComponent.__proto__ || Object.getPrototypeOf(AuthenticatedComponent)).call.apply(_ref, [this].concat(args))), _this), _this.state = { user: verifyUser() }, _temp), _possibleConstructorReturn(_this, _ret);
  }
