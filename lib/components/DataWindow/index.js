    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        function (_ref) {
          ...
          return children({ window: window, height: height, width: width, itemHeight: itemHeight, virtualPageHeight: virtualPageHeight, itemsInView: itemsInView, itemsInWindow: itemsInWindow, onPage: function onPage(position) {
