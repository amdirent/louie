...
var LoginForm = function (_React$PureComponent) {
  ...
  function LoginForm(props) {
    ...
    _this.state = { error: null, buttonText: 'login', showSpinner: false };
  ...
  _createClass(LoginForm, [{
    ...
    value: function onFormSubmit(e) {
      ...
      this.setState({ showSpinner: true, buttonText: 'authenticating...' }, function () {
        handler(e);
      });
    }
  }, {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'button',
              { className: this.state.showSpinner ? 'loading' : '' },
