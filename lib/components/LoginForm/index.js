...
var LoginForm = function (_React$PureComponent) {
  ...
  _createClass(LoginForm, [{
    ...
    value: function render() {
      ...
      var defaultSubmissionHandler = function defaultSubmissionHandler(event) {
        if (event) event.preventDefault();
        console.log(this.refs.usernameInput.value);
        console.log(this.refs.passwordInput.value);
      };

      var onSubmitHandler = this.props.onSubmit ? this.props.onSubmit : defaultSubmissionHandler;
