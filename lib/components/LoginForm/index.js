...
var LoginForm = function (_React$PureComponent) {
  ...
  _createClass(LoginForm, [{
    ...
    value: function handleSubmission(e) {
      ...
      this.auth.login(this.refs.usernameInput.value, this.refs.passwordInput.value, this.props.onAuthenticated, // Success callback
      function (err) {
        // Error callback
    ...
    value: function render() {
      ...
      var onSubmitHandler = this.props.onSubmit ? this.props.onSubmit : this.handleSubmission;
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'form',
            { className: 'login-form', onSubmit: onSubmitHandler },
